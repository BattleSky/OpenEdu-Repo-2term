...
namespace Дженерики_и_сортировка_массивов
{
	...
	/*
	 *
	 * Задание на нахождение максимума в массиве
	 *
	 */
	...
	public class Program
    {
        public static void Main()
        {
			...
			// Эта строка введена для проверки на эксепшн. Эксепшна нет, но результат неоч.
			// Потому что для стринга нет значения по умолчанию - только ссылка.
            Console.ReadLine();
        }
